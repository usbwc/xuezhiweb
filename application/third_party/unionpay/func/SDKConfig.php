...
// 有效期加密 1:加密 0:不加密
const SDK_DATE_ENC = 1;
// 卡号加密 1：加密 0:不加密
const SDK_PAN_ENC = 1;


// 签名证书路径 （联系运营获取两码，在CFCA网站下载后配置，自行设置证书密码并配置）
const SDK_SIGN_CERT_PATH = '/var/unionPay/cert/production/yinlian.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '123123';

// 验签证书
const SDK_VERIFY_CERT_PATH = '/var/unionPay/cert/production/EbppRsaCert.cer';

// 密码加密证书
const SDK_ENCRYPT_CERT_PATH = '/var/unionPay/cert/production/encryptpub.cer';

// 验签证书路径
const SDK_VERIFY_CERT_DIR = '/var/unionPay/cert/production/';
...
// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL = 'http://182.92.101.89/flower/payBackFromUnionPay';

//文件下载目录 
const SDK_FILE_DOWN_PATH = '/var/unionPay/down';

//日志 目录 
const SDK_LOG_FILE_PATH = '/var/unionPay/logs';
